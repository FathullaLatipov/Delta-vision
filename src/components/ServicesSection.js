...
export default function ServicesSection() {
    ...
    return (
        <section id="benefits" className="py-12 px-4 md:py-16 md:px-6 lg:px-12 xl:px-24 relative overflow-hidden">
            {/* Background gradient */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <p className="text-gray-400 text-xs md:text-sm font-medium tracking-wider uppercase mb-4 md:mb-6">Кейсы</p>
                    <div className='md:flex justify-between items-start'>
                        <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight max-w-4xl mb-6 md:mb-0">
                            <span className="gradient-text">Кейсы</span> Delta Vision
                        </h2>

                        <div className="flex gap-3 md:gap-4 mt-4">
                            <motion.button
                                className={`text-sm md:text-base lg:text-lg font-medium px-5 py-3 rounded-2xl transition-all duration-300 cursor-pointer ${
                    ...
                    <AnimatePresence mode="wait">
                        {services.map((service, index) => {
                            ...
                            return (
                                ...
                                >
                                    <motion.div
                                        className="py-6 md:py-8 lg:py-12 flex items-start justify-between group glass border border-white/10 rounded-2xl hover:border-white/20 transition-all duration-500 ease-out px-4 md:px-6 cursor-pointer hover-lift"
                                    ...
                                    >
                                        <div className="flex-1">
                                            <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-8 lg:gap-12">
                                                <motion.span 
                                                    className="text-lg md:text-2xl lg:text-3xl font-bold gradient-text-accent md:min-w-[60px] transition-all duration-300"
                                                    whileHover={{ scale: 1.1 }}
                                                >
                                                    {service.number}
                                                </motion.span>
                                                <div className="flex-1">
                                                    <h3 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold mb-2 transition-all duration-300 leading-tight text-white group-hover:text-gray-100">
                                                        {service.title}
                                                    </h3>
                                                    {service.subtitle && (
                                                        <h4 className="text-lg md:text-xl lg:text-2xl font-medium mb-4 md:mb-6 text-gray-400">
                                                            {service.subtitle}
                                                        </h4>
                                                    )}
                                                    <AnimatePresence>
                                                        {isExpanded && (
                                                            ...
                                                            >
                                                                <div className="flex flex-col lg:flex-row gap-4 md:gap-6 lg:gap-12 pb-4 w-full">
                                                                    <div className="w-full lg:flex-1">
                                                                        <div className="text-gray-300 text-sm md:text-base lg:text-lg leading-relaxed">
                                                                            {service.description}
                                                                        </div>
                                                                    </div>
                                                                    {service.hasImage && (
                                                                        <motion.div 
                                                                            className="w-full lg:w-80 h-40 md:h-48 rounded-xl flex-shrink-0 overflow-hidden mt-4 lg:mt-0"
                                        ...
                                        <div className="ml-4 md:ml-8 flex gap-2 flex-shrink-0">
                                            <motion.button 
                                                className="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-gradient-premium text-white rounded-full flex items-center justify-center shadow-glow hover:shadow-glow-lg"
                                            ...
                                            <motion.button
                                                className="px-4 py-2 bg-white text-black rounded-full text-sm font-semibold shadow-glow hover:shadow-glow-lg transition-all duration-300"
                                                whileHover={{ scale: 1.05 }}
                                                whileTap={{ scale: 0.95 }}
                                                onClick={(e) => {
                                                    e.stopPropagation()
