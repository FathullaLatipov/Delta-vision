...
const testimonials = [
    {
        ...
        title: "ОТЗЫВЫ",
        content:
            "Работа с «Delta Vision» для нашей компании — это оптимальный вариант. Содержать в штате отдельно IT-специалистов считаю экономически нецелесообразно. При этом сотрудник будет узконаправленным, а результаты его работы не всегда будут решать стоящие перед компанией задачи. Оптимальнее работать с группой специалистов , которые видят задачу во всех ракурсах и совместно предлагают лучшее решение заказчику. Мы профессионально занимаемся производством и продажой сэндвич-панелей и профнастила по Узбекистану и СНГ , Delta Vision занимаются рекламной нашей продукции в интернет пространстве. От лица компании выражаю благодарность и желаю дальнейшего взаимовыгодного сотрудничества",
        author: "Хикматов Ж.",
